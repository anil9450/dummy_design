...
const Migration = () => {
  return (
    <div className="mx-auto sm:w-3/4 px-4 sm:px-6 lg:px-8 mt-20">
      ...
      <div>
        ...
        <div className=" bg-gray-100 rounded p-4 w-full">
          ...
          <p className="text-xs mt-4">
            ...
            assessment, planning, and execution to
          </p>
          <p className="text-center text-xs">
            ensure minimal disruption and maximum efficiency.
          </p>
          <p className="mt-4 text-xs">
            ...
            address these differences early in the
          </p>

          <p className="text-xs text-center">
            planning phase to ensure that the formatting is properly migrated
            across platforms.
          </p>
        </div>
      </div>
